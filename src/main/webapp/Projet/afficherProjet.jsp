...
<header>
    <div class="container">
        ...
        <div class="add-project">
            <button class="btn btn-primary"><a href="projet?action=new">+ Nouveau Projet</a></button>
        </div>
            ...
            <tr>
                ...
                <td>
                    <div class="action-buttons">
                        <button class="btn btn-primary"><a href="projet?action=trouverParid&id=${projet.id_PR}" class="edit-link">Modifier</a></button>
                        <button class="btn btn-danger"><a href="projet?action=supprimer&id_PR=${projet.id_PR}" class="delete-link">Supprimer</a></button>
                        <button class="btn btn-primary"> <a href="tache?action=parProjet&projet_id=${projet.id_PR}" class="view-link">Afficher</a></button>
                    </div>
                </td>
            </tr>
            </c:forEach>
